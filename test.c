...
void simple_func(void) { return; }

int complex_func(int a, char *b, void (*callback)(void)) { return a; }
...
void higher_order(void (*callback)(int), int arg) { callback(arg); }
